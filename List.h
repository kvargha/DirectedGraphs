...
void insertBefore(List L, Node N, int data); // Insert a new Node into Node Nâ€™s list
...
void insertAfter(List L, Node N, int data); // Insert a new Node into Node Nâ€™s list
